...
void crear_pantalla_principal() {
  ...
  lv_label_set_text(header_label, LV_SYMBOL_SETTINGS " BOBINADORA CNC v10.2");
...
void crear_pantalla_control_manual() {
  ...
  lv_obj_t *btn_x_minus = UI::create_button(
      x_cont, LV_SYMBOL_LEFT " -1mm", "X-", &UI::style_btn_warning,
      UIHandlers::btn_manual_handler, 150, 40);
  lv_obj_t *btn_x_plus = UI::create_button(
      x_cont, "+1mm " LV_SYMBOL_RIGHT, "X+", &UI::style_btn_warning,
      UIHandlers::btn_manual_handler, 150, 40);
  ...
  lv_obj_t *btn_y_minus = UI::create_button(
      y_cont, LV_SYMBOL_MINUS " -1 Vuelta", "Y-", &UI::style_btn_warning,
      UIHandlers::btn_manual_handler, 150, 40);
  lv_obj_t *btn_y_plus = UI::create_button(
      y_cont, LV_SYMBOL_PLUS " +1 Vuelta", "Y+", &UI::style_btn_warning,
      UIHandlers::btn_manual_handler, 150, 40);
}
