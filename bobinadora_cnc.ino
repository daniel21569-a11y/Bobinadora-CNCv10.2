// =========================================================================
// BOBINADORA CNC CON LVGL - VERSIÓN OPTIMIZADA DUAL-CORE
// VERSIÓN: 10.2 - HONEYCOMB OPTIMIZADO + HOMING MEJORADO
// =========================================================================
// CAMBIOS CLAVE:
// - Core 1: SOLO timing crítico de pulsos (motor_task_optimized.h)
// - Honeycomb: Dirección en cada paso (suavidad perfecta)
// - Homing: 3.3x más rápido + retroceso 5mm exactos
// - Sin interferencias UI → motores
// =========================================================================
...
// Hardware
TAMC_GT911 touchController(Hardware::Touch::SDA_PIN, Hardware::Touch::SCL_PIN,
                           Hardware::Touch::INT_PIN, Hardware::Touch::RST_PIN,
...
void logging_task(void *pvParameters) {
  ...
  for (;;) {
    ...
    if (Sistema::estado.modo == ModoBobinado::NIDO_ABEJA &&
      ...
      float grosor_actual = Sistema::estado.capas_completadas *
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("========================================");
  Serial.println("BOBINADORA CNC v10.2 - OPTIMIZADA");
  ...
  lv_display_set_buffers(disp, disp_draw_buf, NULL, bufSize,
  ...
  xTaskCreatePinnedToCore(
      ...
      "MotorCore1", Hardware::Memory::TASK_STACK_SIZE, NULL,
